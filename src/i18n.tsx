...
Ceci est un projet de fan non officiel et n'est pas affilié, approuvé ou sponsorisé par FryxGames, Intrafin ou Jonathan Fryxelius. Tous les droits sur le jeu original, les règles et les illustrations restent la propriété de leurs détenteurs respectifs.`,
  ...
  guideContent: `<ul class="list-disc pl-5">
    ...
    effect_description_forest: "effects/activate Gagnez resources/wood resources/wood resources/wood , puis → i18n/felled_forest .",
    ...
    effect_description_explorers: "effects/activate Découvrez un nouveau territoire (71/72/73/74), puis → i18n/stone_bridge .",
    ...
    effect_description_volcanic_eruption: "effects/forced Tant qu'elle est en jeu, détruisez le prochain Terrain que vous jouez; lorsque vous le faite, → i18n/ashlands .",
    ...
    effect_description_thunderstorm: "effects/forced Carte jouée: défaussez les 3 premières cartes de votre deck, puis → i18n/rain .",
    effect_description_rain: "effects/passive Les Terrains produisent +2 resources/coin en plus. effects/passive Vous ne pouvez pas progresser. effects/forced Fin du Tour: → i18n/thunderstorm .",
    effect_description_dark_knight: "effects/passive Vous ne pouvez pas progresser . effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre → i18n/impressed_boy .",
    ...
    effect_description_witch: "effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre ( effects/destroy ). effects/activate Défaussez 3 Personnes pour → i18n/witch_cabin . effects/forced Fin du tour: Découvrez les 2 prochaines cartes de la boîte, puis → i18n/witch_cabin .",
    ...
    effect_description_plague: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 2 Personnes de votre royaume, puis → i18n/enemy_soldier .",
    ...
    effect_description_assassin: "effects/forced Détruisez la prochaine Personne que vous jouez, lorsque vous le faites, → i18n/enemy_soldier . effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre → i18n/enemy_soldier .",
    effect_description_city_fire: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 1 Bâtiment de votre royaume, puis → i18n/ashlands .",
    ...
    effect_description_dark_prince: "effects/passive Vous ne pouvez pas progresser. effects/activate Dépensez resources/sword resources/sword resources/sword resources/sword resources/sword pour vaincre → i18n/impressed_boy .",
    effect_description_innkeeper: "effects/activate Défaussez une autre Personne pour gagner 2 ressources de votre choix.",
    effect_description_tornado: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 3 cartez alliées du royaume (non-permanentes), puis → i18n/flooding .",
    ...
    effect_description_young_princess: "effects/forced Fin du Tour: Défaussez 2 Personnes ou → i18n/spoiled_princess .",
    ...
    effect_description_cooperation: "effects/activate Défaussez 2 Personnes pour gagner 3 ressources au choix puis → i18n/favor .",
    effect_description_favor: "effects/passive Reste en jeu. effects/activate Gagnez 1 ressource au choix, puis → i18n/cooperation .",
    ...
    effect_description_dubbing: "effects/passive Reste en jeu. effects/forced Fin de Manche: Ajoutez resources/coin resources/sword et \"Chevalier\" à 1 Personne, puis → i18n/renovation .",
    ...
    effect_description_pit_settlement: "effects/activate Marquer 1 effects/check , une fois complet → i18n/prison .",
    ...
    effect_description_build_an_ark: "effects/time dépensez les resources/wood pour resources/check , une fois complétée, → i18n/the_ark ",
    ...
    effect_description_compass: "effects/activate Inscrivez 1 effects/check pour chaque carte Maritime en jeu, celle-ci incluse, une fois complète, → i18n/navigation .",
    effect_description_navigation: "effects/activate Inscrivez 1 effects/check pour chaque carte Maritime en jeu, celle-ci incluse, une fois complète, → i18n/astrolabe .",
    ...
    effect_description_astrolabe: "effects/activate Inscrivez 1 effects/check pour chaque carte Maritime en jeu, celle-ci incluse, une fois complète, → i18n/calendar .",
    ...
    effect_description_fish_quota: "effects/activate Inscrivez 1 effects/check , une fois complété, → i18n/fishing_excellence .",
    ...
    effect_description_small_school: "effects/time Améliorez gratuitement 1 Personne en jeux, puis → i18n/school .",
    effect_description_school: "effects/time Améliorez gratuitement 1 Personne en jeux, puis → i18n/prominent_school .",
    effect_description_renowned_school: "effects/time Ajoutez 1 ressource à une Personne en jeux, puis effects/oneTime .",
    effect_description_prominent_school: "effects/time Ajoutez 1 ressource à une Personne en jeux, puis → i18n/renowed_school .",
    effect_description_investor_1: "effects/activate Gagnez 3 ressources au choix, puis →.",
    effect_description_investor_2: "effects/activate Gagnez 3 ressources au choix, puis →.",
    effect_description_investor_3: "effects/activate Gagnez 1 ressource au choix.",
    effect_description_investor_4: "effects/activate Gagnez 3 ressources au choix, puis →. (Ne donnera plus qu'une ressource)",
    ...
    effect_description_handsome_rival: "Vaut -5 pour chaque case non effects/check . effects/passive Ne peut pas être détruit, à moins que Lord Nimrod n'ai été détruit. effects/activate Défaussez Lord Nimrod et dépensez les ressources d'une case pour inscrire effects/check , une fois complétées, → i18n/noble_ally .",
    ...
    effect_description_bandit_ridding_the_woods: "Peut être → par un Missionaire. effects/forced Carte jouée: Défaussez toutes les cartes qui produisent de resources/wood . effects/time Dépensez resources/sword resources/sword resources/sword pour vaincre → i18n/prisoner .",
    ...
    effect_description_unsafe_forest: "Vous devez avoir les ressources avant de vaincre l'Ennemi pour activer l'effet. effects/optional Lorsque vous vainquez un Ennemi, dépensez resources/coin resources/coin resources/coin resources/coin resources/sword resources/sword pour → i18n/peaceful_forest .",
    ...
    effect_description_huge_robber: "effects/passive Vous ne pouvez pas i18n/advance . effects/activate Défaussez 4 Personnes pour le vaincre → i18n/prisoner .",
    ...
    effect_description_robber_veteran: "effects/forced Carte jouée: Défaussez toutes les cartes qui produisent de resources/coin . effects/activate Dépensez resources/sword resources/sword resources/sword resources/sword resources/sword pour vaincre → i18n/prisoner .",
    ...
    effect_description_rescuer: "effects/forced Carte jouée: Jouez 1 Prisonnier depuis la défausse. effects/time Dépensez resources/metal resources/metal resources/metal pour vaincre → i18n/prisoner .",
    ...
    effect_description_ceremony: "effects/activate Défaussez 5 cartes alliées en jeu pour ajouter 5 resources/fame à l'une d'entre elles, puis → i18n/hill_megalith .",
    ...
    effect_description_treasury: "effects/time dépensez les resources/coin pour effects/check suivant, à la dernière, → i18n/famed_treasury .",
...
This is an unofficial fan project and is not affiliated with, endorsed by, or sponsored by FryxGames, Intrafin, or Jonathan Fryxelius. All rights to the original game, rules, and artwork remain with their respective copyright holders.`,
  ...
  guideContent: `<ul class="list-disc pl-5">
    ...
    effect_description_forest: "effects/activate Gain resources/wood resources/wood resources/wood , then → i18n/felled_forest .",
    ...
    effect_description_explorers: "effects/activate Discover a new territory (71/72/73/74), then → i18n/stone_bridge .",
    ...
    effect_description_volcanic_eruption: "effects/forced While in play, destroy the next Land you play; when you do, → i18n/ashlands .",
    ...
    effect_description_thunderstorm: "effects/forced Card played: discard the top 3 cards of your deck, then → i18n/rain .",
    effect_description_rain: "effects/passive Land product +2 resources/coin . effects/passive You cannot advance. effects/forced End of Turn: → i18n/thunderstorm .",
    effect_description_dark_knight: "effects/passive You cannot advance. effects/activate Spend resources/sword resources/sword resources/sword to defeat → i18n/impressed_boy .",
    ...
    effect_description_witch: "effects/activate Spend resources/sword resources/sword resources/sword to defeat ( effects/destroy ). effects/activate Discard 3 People to → i18n/witch_cabin . effects/forced End of turn: Discover the next 2 cards from the box, then → i18n/witch_cabin .",
    ...
    effect_description_plague: "effects/passive Stays in play. effects/forced End of Round: Destroy 2 People from your kingdom, then → i18n/enemy_soldier .",
    ...
    effect_description_assassin: "effects/forced Destroy the next Person you play, when you do, → i18n/enemy_soldier . effects/activate Spend resources/sword resources/sword resources/sword to defeat → i18n/enemy_soldier .",
    effect_description_city_fire: "effects/passive Stays in play. effects/forced End of Round: Destroy 1 Building from your kingdom, then → i18n/ashlands .",
    ...
    effect_description_dark_prince: "effects/passive You cannot advance. effects/activate Spend resources/sword resources/sword resources/sword resources/sword resources/sword to defeat → i18n/impressed_boy .",
    effect_description_innkeeper: "effects/activate Discard another Person to gain 2 resources of your choice.",
    effect_description_tornado: "effects/passive Stays in play. effects/forced End of Round: Destroy 3 friendly (non-permanent) cards from the kingdom, then → i18n/flooding .",
    ...
    effect_description_young_princess: "effects/forced End of Turn: Discard 2 People or → i18n/spoiled_princess .",
    ...
    effect_description_cooperation: "effects/activate Discard 2 People to gain 3 resources of your choice then → i18n/favor .",
    effect_description_favor: "effects/passive Stays in play. effects/activate Gain a resource of your choice, then → i18n/cooperation .",
    ...
    effect_description_dubbing: "effects/passive Stays in play. effects/forced End of Round: Add resources/coin resources/sword and \"Knight\" to 1 Person, then → i18n/ renovation.",
    ...
    effect_description_pit_settlement: "effects/activate Mark 1 effects/check , once complete → i18n/prison .",
    ...
    effect_description_build_an_ark: "effects/time Spend resources/wood to resources/check , once completed, → i18n/the_ark ",
    ...
    effect_description_compass: "effects/activate Mark 1 effects/check for each Seafaring card in play, including this one, once complete, → i18n/navigation .",
    effect_description_navigation: "effects/activate Mark 1 effects/check for each Seafaring card in play, including this one, once complete, → i18n/astrolabe .",
    ...
    effect_description_astrolabe: "effects/activate Mark 1 effects/check for each Seafaring card in play, including this one, once complete, → i18n/calendar .",
    ...
    effect_description_fish_quota: "effects/activate Mark 1 effects/check , once completed, → i18n/fishing_excellence .",
    ...
    effect_description_small_school: "effects/time Upgrade 1 Person in play for free, then → i18n/school .",
    effect_description_school: "effects/time Upgrade 1 Person in play for free, then → i18n/prominent_school .",
    effect_description_renowned_school: "effects/time Add 1 resource to a Person in play, then effects/oneTime .",
    effect_description_prominent_school: "effects/time Add 1 resource to a Person in play, then → i18n/renowned_school .",
    effect_description_investor_1: "effects/activate Gain 3 resources of your choice, then →.",
    effect_description_investor_2: "effects/activate Gain 3 resources of your choice, then →.",
    effect_description_investor_3: "effects/activate Gain 1 resource of your choice.",
    effect_description_investor_4: "effects/activate Gain 3 resources of your choice, then →. (Will only generate 1 resource)",
    ...
    effect_description_handsome_rival: "Worth -5 for each unchecked box. effects/passive Cannot be destroyed, unless Lord Nimrod has been destroyed. effects/activate Discard Lord Nimrod and spend the resources of a box to mark effects/check , once completed, → i18n/noble_ally .",
    ...
    effect_description_bandit_ridding_the_woods: "May be → by a Missionary. effects/forced Card Played: Discard every card with a production of resources/wood . effects/time Spend resources/sword resources/sword resources/sword to defeat → i18n/prisoner .",
    ...
    effect_description_unsafe_forest: "you must first have the resources before defeating the Enemy to use this effect. effects/optional When you defeat an Enemy, spend resources/coin resources/coin resources/coin resources/coin resources/sword resources/sword to → i18n/peaceful_forest .",
    ...
    effect_description_huge_robber: "effects/passive You cannot i18n/advance . effects/activate Discard 4 People to defeat → i18n/prisoner .",
    ...
    effect_description_robber_veteran: "effects/forced Card Played: Discard every card with a production of resources/coin . effects/activate Spend resources/sword resources/sword resources/sword resources/sword resources/sword to defeat → i18n/prisoner .",
    ...
    effect_description_rescuer: "effects/forced Card Played: Play 1 Prisoner from the discard. effects/time Spend resources/metal resources/metal resources/metal to defeat → i18n/prisoner .",
    ...
    effect_description_ceremony: "effects/activate Discard 5 friendly cards from play to add 5 resources/fame to 1 of them, then → i18n/hill_megalith .",
    ...
    effect_description_treasury: "effects/time Spend resources/coin to effects/check , after the last one → i18n/famed_treasury .",
