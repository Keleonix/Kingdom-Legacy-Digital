...
Ceci est un projet de fan non officiel et n'est pas affilié, approuvé ou sponsorisé par FryxGames, Intrafin ou Jonathan Fryxelius. Tous les droits sur le jeu original, les règles et les illustrations restent la propriété de leurs détenteurs respectifs.`,
  ...
  guideContent: `<ul class="list-disc pl-5">
    ...
    effect_description_army: "effects/time Dépensez les resources/sword (1 à 10, incrément de 1) pour cocher la case de gauche à droite, à la dernière carte, → i18n/grand_army et découvrez l'Etat Vassal (135).",
    ...
    effect_description_treasure: "effects/time dépensez les resources/coin (1 à 12, incrément de 1) pour cocher la case de gauche à droite, à la dernière carte, → i18n/extended_treasure .",
    ...
    effect_description_build_an_ark: "effects/time dépensez les resources/wood (2 à 10, incrément de 2) pour cocher la case de gauche à droite, une fois complétée, → i18n/the_ark ",
...
This is an unofficial fan project and is not affiliated with, endorsed by, or sponsored by FryxGames, Intrafin, or Jonathan Fryxelius. All rights to the original game, rules, and artwork remain with their respective copyright holders.`,
  ...
  guideContent: `<ul class="list-disc pl-5">
    ...
    effect_description_army: "effects/time Spend resources/sword (1 to 10, increment of 1) to check the box from left to right. At the last card, → i18n/grand_army and discover the Vassal State (135).",
    effect_description_grand_army: "effects/time Spend resources/sword (10, 10, 12, 12, 15) to check the box from left to right.",
    effect_description_treasure: "effects/time Spend resources/coin (1 to 12, increment of 1) to check the box from left to right, at the last card, → i18n/extended_treasure .",
    ...
    effect_description_build_an_ark: "effects/time Spend resources/wood (2 to 10, increment of 2) to check the box from left to right, once completed, → i18n/the_ark ",
