...
export type TranslationKeys = 
  ...
  | 'ach_name_digging_a_hole' | 'ach_desc_digging_a_hole'
  | 'ach_name_let_them_cook' | 'ach_desc_let_them_cook'
  | 'ach_name_there_is_more' | 'ach_desc_there_is_more'
  | 'ach_name_the_hunter' | 'ach_desc_the_hunter'
  | 'ach_name_trading_imperialism' | 'ach_desc_trading_imperialism'
  | 'ach_name_peace_was_never_an_option' | 'ach_desc_peace_was_never_an_option'
  ...
  | 'effect_description_fleet_maneuvers'
...
Adaptation des arts / assets numériques : Freepik, Smashicons, images générées par IA avec PixelLab
...
Ceci est un projet de fan non officiel et n'est pas affilié, approuvé ou sponsorisé par FryxGames, Intrafin ou Jonathan Fryxelius. Tous les droits sur le jeu original, les règles et les illustrations restent la propriété de leurs détenteurs respectifs.`,
  ...
  guideContent: `<ul class="list-disc pl-5">
    ...
    tutorialActionButtonsText: "Gérez votre tour ici : « i18n/newTurn » pour défausser les cartes en jeu et piocher 4 cartes. « i18n/advance » pour piocher 2 nouvelles cartes, « i18n/endRound » quand votre deck est vide pour terminer la manche.",
    ...
    noCheckboxAvailable: 'Pas de boîte à sélectionner.',
    ...
    ach_name_digging_a_hole: 'Un Gros Trou',
    ach_desc_digging_a_hole: 'Obtenir les deux Mines en une partie',
    ach_name_let_them_cook: 'Grande Cuisine',
    ach_desc_let_them_cook: 'Ayez 30+ cartes en jeu.',
    ach_name_there_is_more: 'Toujours Plus',
    ach_desc_there_is_more: 'Sélectionnez une extension.',
    ach_name_the_hunter: 'Le Chasseur',
    ach_desc_the_hunter: 'Vainquez trois Ennemis en un tour.',
    ach_name_trading_imperialism: 'Monopole Commercial',
    ach_desc_trading_imperialism: 'Obtenez les Relations Commerciales',
    ach_name_peace_was_never_an_option: 'La Paix en Option',
    ach_desc_peace_was_never_an_option: 'Complétez la Grande Armée.',
    ach_name_richer_than_cresus: 'Plus Riche que Crésus',
    ach_desc_richer_than_cresus: 'Complétez l\'Immense Trésor.',
    ach_name_adhd: 'ADHD',
    ...
    fleet_maneuvers: 'Manœuvrer la Flotte',
    planning: 'Préparation',
    well_prepared: 'Bien Préparé',
    hardships: 'Moments Difficiles',
    friendship: 'Camaraderie',
    sun_stroke: 'Insolation',
    thirst: 'Soif',
    historian: 'Historienne',
    handy_craftsman: 'Artisan Habile',
    seasick: 'Mal de Mer',
    new_normal: 'Nouvelle Normalité',
    passenger_list: 'Liste de Passagers',
    madman: 'Fou',
    ...
    effect_description_forest: "effects/activate Gagnez resources/wood resources/wood resources/wood , puis effects/arrow i18n/felled_forest .",
    effect_description_sacred_well: "effects/destroy Découvrez un i18n/shrine (82/83).",
    ...
    effect_description_explorers: "effects/activate Découvrez un nouveau territoire (71/72/73/74), puis effects/arrow i18n/stone_bridge .",
    ...
    effect_description_bandit: "Peut être effects/arrow par un Missionaire. effects/forced Carte Jouée : Bloque 1 carte avec production d' resources/coin . effects/activate Dépensez resources/sword pour vaincre ( effects/destroy ) et gagner 2 ressources au choix.",
    ...
    effect_description_army: "effects/time Dépensez les resources/sword pour resources/check, et à la dernière, effects/arrow i18n/grand_army et découvrez l'Etat Vassal (135).",
    effect_description_grand_army: "effects/time Dépensez les resources/sword pour resources/check .",
    effect_description_treasure: "effects/time dépensez les resources/coin pour resources/check , à la dernière, effects/arrow i18n/extended_treasure .",
    effect_description_extended_treasure: "effects/time dépensez les resources/coin pour resources/check .",
    effect_description_export: "Dépensez des resources/tradegood pour atteindre des paliers, 10: Ajoutez resources/coin / resources/wood / resources/stone sur un Terrain, 20: Un Personnage gagne \" effects/passive Reste en jeu\", 30: Découvrez Adoubement (86), 40: Ajoutez resources/metal / resources/sword / resources/tradegood sur 1 Bâtiment, 55: Ajoutez resources/wood / resources/stone / resources/metal / resources/sword sur une carte, 75: Ajoutez resources/fame x5 sur une carte, 100: effects/arrow i18n/mass_export . effects/passive Dépensez des resources/tradegood .",
    ...
    effect_description_volcanic_eruption: "effects/forced Tant qu'elle est en jeu, détruisez le prochain Terrain que vous jouez; lorsque vous le faite, effects/arrow i18n/ashlands .",
    ...
    effect_description_stop_3: "effects/activate Découvrez les cartes 38 à 42 et choisissez le côté des cartes Objectif.",
    ...
    effect_description_expanding_borders: "Votre royaume doit comprendre 75 cartes ou plus (hors permanentes). Cette carte vaut -2 resources/fame pour chaque carte manquante.",
    effect_description_maximizer: "Vaut -1 resources/fame par carte valant 0 resources/fame (hors permanentes).",
    effect_description_loyalty: "Vaut 25 resources/fame s'il n'y a plus d'ennemi dans votre royaume.",
    effect_description_trader_obj: "Vaut 25 resources/fame si votre production de resources/tradegood est de 10 ou plus.",
    effect_description_jester: "effects/passive Reste en jeu. effects/activate Défaussez la carte au sommet de votre deck. effects/activate Ajoutez 1 effects/check .",
    ...
    effect_description_thunderstorm: "effects/forced Carte jouée: défaussez les 3 premières cartes de votre deck, puis effects/arrow i18n/rain .",
    effect_description_rain: "effects/passive Les Terrains produisent +2 resources/coin en plus. effects/passive Vous ne pouvez pas progresser. effects/forced Fin du Tour: effects/arrow i18n/thunderstorm .",
    effect_description_dark_knight: "effects/passive Vous ne pouvez pas progresser . effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre effects/arrow i18n/impressed_boy .",
    ...
    effect_description_ambassador: "effects/time Dépensez resources/coin resources/coin resources/coin pour découvrir une allié (121).",
    effect_description_diplomat: "effects/time Dépensez resources/coin resources/coin resources/coin pour découvrir le Consort (122).",
    ...
    effect_description_witch: "effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre ( effects/destroy ). effects/activate Défaussez 3 Personnes pour effects/arrow i18n/witch_cabin . effects/forced Fin du tour: Découvrez les 2 prochaines cartes de la boîte, puis effects/arrow i18n/witch_cabin .",
    ...
    effect_description_plague: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 2 Personnes de votre royaume, puis effects/arrow i18n/enemy_soldier .",
    ...
    effect_description_assassin: "effects/forced Détruisez la prochaine Personne que vous jouez, lorsque vous le faites, effects/arrow i18n/enemy_soldier . effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre effects/arrow i18n/enemy_soldier .",
    effect_description_city_fire: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 1 Bâtiment de votre royaume, puis effects/arrow i18n/ashlands .",
    effect_description_lost_civilization: "effects/activate Défaussez 6 cartes alliées pour découvrir un Artefact (108).",
    effect_description_skilled_bandit: "Peut être effects/arrow par un Missionaire. effects/forced Carte jouée: Bloque 3 cartes avec une production. effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre ( effects/destroy ) et gagner 3 ressources au choix.",
    effect_description_dark_prince: "effects/passive Vous ne pouvez pas progresser. effects/activate Dépensez resources/sword resources/sword resources/sword resources/sword resources/sword pour vaincre effects/arrow i18n/impressed_boy .",
    effect_description_innkeeper: "effects/activate Défaussez une autre Personne pour gagner 2 ressources de votre choix.",
    effect_description_tornado: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 3 cartez alliées du royaume (non-permanentes), puis effects/arrow i18n/flooding .",
    effect_description_flooding: "effects/passive Reste en jeu. effects/forced Bloque tous les Bâtiments (max 5). effects/forced Fin de Manche: Détruisez cette carte et 1 Bâtiment bloqué ou 2 autres cartes alliées (non-permanentes).",
    effect_description_young_princess: "effects/forced Fin du Tour: Défaussez 2 Personnes ou effects/arrow i18n/spoiled_princess .",
    ...
    effect_description_sickness: "effects/forced Carte Jouée: Défaussez les 2 prochaines cartes de votre deck.",
    ...
    effect_description_stop_5: "effects/activate Découvrez les cartes 69 et 70, à la fin de la manche comptez votre resources/fame (Fin du jeu).",
    ...
    effect_description_royal_visit: "effects/activate Retirez 1 ressource de ressource dans le coût d'amélioration d'une carte en jeu.",
    effect_description_inquisitor: "effects/destroy Détruisez une carte effects/negative en jeu.",
    ...
    effect_description_cooperation: "effects/activate Défaussez 2 Personnes pour gagner 3 ressources au choix puis effects/arrow i18n/favor .",
    effect_description_favor: "effects/passive Reste en jeu. effects/activate Gagnez 1 ressource au choix, puis effects/arrow i18n/cooperation .",
    effect_description_aethan_estate_1: "effects/forced Lorsque vous purgez cette carte, vous pouvez annuler la purge de 1 autre carte.",
    effect_description_aethan_estate_2: "effects/forced Lorsque vous purgez cette carte, vous pouvez annuler la purge de 3 autres cartes.",
    effect_description_aethan_estate_3: "effects/forced Lorsque vous purgez cette carte, vous pouvez annuler la purge de 2 autres cartes.",
    ...
    effect_description_dubbing: "effects/passive Reste en jeu. effects/forced Fin de Manche: Ajoutez resources/coin resources/sword et \"Chevalier\" à 1 Personne, puis effects/arrow i18n/renovation .",
    ...
    effect_description_quests: "effects/time défaussez des Personnes pour resources/check .",
    effect_description_a_perfect_tower: "effects/time dépensez les resources/stone pour resources/check .",
    effect_description_town_well: "effects/passive La production des Bâtiments gagne +1 resources/coin .",
    effect_description_pit_settlement: "effects/activate Marquer 1 effects/check , une fois complet effects/arrow i18n/prison .",
    ...
    effect_description_jewellery: "effects/time dépensez les resources/metal pour resources/check , puis gagnez 5 resources/tradegood .",
    effect_description_build_an_ark: "effects/time dépensez les resources/wood pour resources/check , une fois complétée, effects/arrow i18n/the_ark ",
    ...
    effect_description_blood_curse: "effects/forced Lorsque vous Progressez, jouez 2 cartes supplémentaires.",
    ...
    effect_description_astrologist: "effects/activate Remettez au-dessus ou en-dessous de votre deck jusqu'à 3 autres de vos cartes en jeu.",
    ...
    effect_description_compass: "effects/activate Inscrivez 1 effects/check pour chaque carte Maritime en jeu, celle-ci incluse, une fois complète, effects/arrow i18n/navigation .",
    effect_description_navigation: "effects/activate Inscrivez 1 effects/check pour chaque carte Maritime en jeu, celle-ci incluse, une fois complète, effects/arrow i18n/astrolabe .",
    effect_description_calendar: "effects/activate Inscrivez 1 effects/check pour prendre 15 cartes au hasard de votre défausse et les placer en-dessous de votre deck.",
    effect_description_astrolabe: "effects/activate Inscrivez 1 effects/check pour chaque carte Maritime en jeu, celle-ci incluse, une fois complète, effects/arrow i18n/calendar .",
    effect_description_saw_mill: "effects/activate Découvrez Construire une Arche (91).",
    effect_description_wood_shipment: "effects/passive Combine et échange vos resources/tradegood et resources/wood .",
    effect_description_larger_barns: "effects/optional Fin du Tour: cette carte ou une autre au choix reste en jeu.",
    effect_description_royal_storehouse: "effects/passive Reste en jeu. effects/optional Fin du Tour: 1 carte au choix reste en jeu.",
    effect_description_fish_quota: "effects/activate Inscrivez 1 effects/check , une fois complété, effects/arrow i18n/fishing_excellence .",
    ...
    effect_description_missionary: "effects/activate Dépensez resources/coin resources/coin resources/coin pour convertir (effects/arrow) un Bandit.",
    ...
    effect_description_camelot: "effects/optional Fin du Tour: Si votre deck est vide, inscrivez 1 effects/check . (Vaut 5 resources/fame par effects/check )",
    ...
    effect_description_thriving_countryside: "effects/activate Choisissez une carte en jeu ou dans la défausse, placez-la sous le deck.",
    effect_description_countryside: "effects/activate Remettez une carte en jeu sous le deck.",
    ...
    effect_description_groom: "effects/optional Jouez un cheval depuis la défausse. effects/activate Choisissez un Cheval en jeu avec 0 à 3 ressources, payez resources/coin resources/coin et ajoutez-lui une ressource au choix.",
    ...
    effect_description_eadric_shadowstrike: "effects/passive Reste en jeu. effects/activate Défaussez 1 Personne pour gagner resources/sword resources/sword resources/sword .",
    ...
    effect_description_small_school: "effects/time Améliorez gratuitement 1 Personne en jeux, puis effects/arrow i18n/school .",
    effect_description_school: "effects/time Améliorez gratuitement 1 Personne en jeux, puis effects/arrow i18n/prominent_school .",
    effect_description_renowned_school: "effects/time Ajoutez 1 ressource à une Personne en jeux, puis effects/oneTime .",
    effect_description_prominent_school: "effects/time Ajoutez 1 ressource à une Personne en jeux, puis effects/arrow i18n/renowed_school .",
    effect_description_investor_1: "effects/activate Gagnez 3 ressources au choix, puis effects/arrow.",
    effect_description_investor_2: "effects/activate Gagnez 3 ressources au choix, puis effects/arrow.",
    effect_description_investor_3: "effects/activate Gagnez 1 ressource au choix.",
    effect_description_investor_4: "effects/activate Gagnez 3 ressources au choix, puis effects/arrow. (Ne donnera plus qu'une ressource)",
    effect_description_queen_jeminah: "effects/activate Défaussez 1 Personne comportant 5 resources/fame ou plus pour inscrire 1 effects/check . (Vaut 3 resources/fame par effects/check )",
    ...
    effect_description_temple_of_light: "effects/optional Fin du Tour: Défaussez pour que 5 autre cartes restent en jeu. effects/time dépensez resources/tradegood resources/tradegood resources/tradegood resources/tradegood pour inscrire 1 effects/check . effects/forced Purgée: Cette carte vaut +10 resources/fame par effects/check .",
    ...
    effect_description_watchtower: "effects/passive Vous pouvez regardez les 2 cartes du dessus de votre deck.",
    ...
    effect_description_handsome_rival: "Vaut -5 pour chaque case non effects/check . effects/passive Ne peut pas être détruit, à moins que Lord Nimrod n'ai été détruit. effects/activate Défaussez Lord Nimrod et dépensez les ressources d'une case pour inscrire effects/check , une fois complétées, effects/arrow i18n/noble_ally .",
    ...
    effect_description_bordering_lands: "Vaut la fame de l'étape Etats Vassaux. effects/passive Dépensez resources/sword resources/sword resources/sword resources/sword pour enlever 1 resources/sword du coup d'amélioration. Toutes les étapes ont la même valeur que l'étape finale.",
    effect_description_occupation: "Vaut la fame de l'étape Etats Vassaux. effects/passive Dépensez resources/sword resources/sword resources/sword resources/sword pour enlever 1 resources/sword du coup d'amélioration.",
    effect_description_vassal_states: "effects/activate Réinitialisez cette carte.",
    effect_description_unruly_towns: "Vaut la fame de l'étape Etats Vassaux. effects/passive Dépensez resources/sword resources/sword resources/sword resources/sword pour enlever 1 resources/sword du coup d'amélioration. effects/forced Lorsque vous l'améliorez, ajoutez 20 resources/fame à l'étape finale (max 9x).",
    ...
    effect_description_espionage: "effects/forced Lorsqu'une Personne est jouée, inscrivez 1 effects/check ou défaussez 2 cartes alliées et une fois complétée, défaussez toute votre deck. effects/forced Fin de manche : Change pour Attaque.",
    ...
    effect_description_bandit_ridding_the_woods: "Peut être effects/arrow par un Missionaire. effects/forced Carte jouée: Défaussez toutes les cartes qui produisent de resources/wood . effects/time Dépensez resources/sword resources/sword resources/sword pour vaincre effects/arrow i18n/prisoner .",
    effect_description_prisoner: "effects/forced Si 2 Ennemis sont en jeux, effects/arrow. effects/passive Après avoir choisi les cartes lors d'une purge, vous pouvez ajouter 2 Prisonniers à cette purge.",
    effect_description_robber_forest: "effects/forced Carte jouée: Jouez le Prince des Voleurs depuis la défausse.",
    effect_description_unsafe_forest: "Vous devez avoir les ressources avant de vaincre l'Ennemi pour activer l'effet. effects/optional Lorsque vous vainquez un Ennemi, dépensez resources/coin resources/coin resources/coin resources/coin resources/sword resources/sword pour effects/arrow i18n/peaceful_forest .",
    ...
    effect_description_huge_robber: "effects/passive Vous ne pouvez pas i18n/advance . effects/activate Défaussez 4 Personnes pour le vaincre effects/arrow i18n/prisoner .",
    ...
    effect_description_tax_collector: "Vaut -1 resources/fame par effects/check . effects/forced Mettez un effects/check quand vous produisez avec cette carte.",
    effect_description_robber_veteran: "effects/forced Carte jouée: Défaussez toutes les cartes qui produisent de resources/coin . effects/activate Dépensez resources/sword resources/sword resources/sword resources/sword resources/sword pour vaincre effects/arrow i18n/prisoner .",
    ...
    effect_description_robber_saboteur: "effects/forced Carte jouée: Enlevez 1 production d'1 Bâtiment en jeu. effects/time Dépensez resources/sword resources/sword resources/sword pour vaincre effects/arrow i18n/prisoner .",
    effect_description_rebellious_monk: "effects/forced Carte jouée: Bloque 3 cartes alliées. effects/time Dépensez resources/tradegood resources/tradegood resources/tradegood resources/tradegood pour vaincre effects/arrow i18n/prisoner .",
    ...
    effect_description_rescuer: "effects/forced Carte jouée: Jouez 1 Prisonnier depuis la défausse. effects/time Dépensez resources/metal resources/metal resources/metal pour vaincre effects/arrow i18n/prisoner .",
    ...
    effect_description_ceremony: "effects/activate Défaussez 5 cartes alliées en jeu pour ajouter 5 resources/fame à l'une d'entre elles, puis effects/arrow i18n/hill_megalith .",
    ...
    effect_description_keeper_of_secrets: "effects/forced Carte jouée: Défaussez toutes les autres cartes en jeu, puis effects/arrow i18n/the_chase .",
    effect_description_the_chase: "effects/activate Défaussez 6 cartes alliées pour effects/check la prochaine case verte. effects/forced Fin du tour: effects/check la prochaine case rouge.",
    ...
    effect_description_treasury: "effects/time dépensez les resources/coin pour effects/check suivant, à la dernière, effects/arrow i18n/famed_treasury .",
    effect_description_famed_treasury: "effects/time dépensez les resources/coin pour effects/check .",
    ...
    effect_description_stop_distant_lands_4: 'effects/destroy Votre deck ne contiendra maintenant que vos cartes Maritimes et 6 Personnes, puis effects/arrow toutes les Cargaisons (ça inversera chaque effects/check sur cells-ci) et enfin découvrez 7 cartes (235-241).',
    effect_description_fleet_maneuvers: 'effects/time Défaussez le nombre de cartes Maritimes pour effects/check .',
    effect_description_planning: 'effects/time  Défaussez 1 Personne pour effects/check .',
    effect_description_well_prepared: 'effects/passive Une fois par tour, effects/check pour ne pas terminer le tour quand vous améliorez une carte.',
    effect_description_hardships: 'effects/passive Défaussez 2 Personnes pour effects/check .',
    effect_description_friendship: 'effects/passive Défaussez 2 Personnes pour gagner 1 ressource au choix.',
    effect_description_sun_stroke: 'effects/forced Défaussez la première personne jouée chaque tour sans résoudre ses effets. effects/forced Fin de Manche : effects/arrow .',
    effect_description_thirst: 'effects/forced La première ressource gagnée à chaque tour est perdue. effects/time Dépensez resources/coin resources/coin resources/coin resources/coin pour effects/destroy .',
    effect_description_historian: 'Vaut 2 resources/fame par effects/check . effects/time effects/check .',
    ...
    eor_export_40: " (seuil 40): Ajoutez resources/metal / resources/sword / resources/tradegood à 1 Bâtiment",
    eor_export_55: " (seuil 55): Ajoutez resources/wood / resources/stone / resources/metal / resources/sword à 1 carte",
    eor_export_75: " (seuil 75): Ajoutez resources/fame x5 à 1 carte",
    eor_export_100: " (seuil 100): Retournez la carte",
    eor_mass_export_25: " (seuil 25): Ajoute 1 resources/fame à 2 Terrains",
    eor_mass_export_50: " (seuil 50): Ajoute 5 resources/fame à 1 Personne",
...
Digital Art / Assets Adaptation: Freepik, Smashicons, Generated AI images with PixelLab
...
This is an unofficial fan project and is not affiliated with, endorsed by, or sponsored by FryxGames, Intrafin, or Jonathan Fryxelius. All rights to the original game, rules, and artwork remain with their respective copyright holders.`,
  ...
  guideContent: `<ul class="list-disc pl-5">
    ...
    ach_name_digging_a_hole: 'Digging a Hole',
    ach_desc_digging_a_hole: 'Obtain the two Mines in one game',
    ach_name_let_them_cook: 'Let Them Cook',
    ach_desc_let_them_cook: 'Have 30+ cards in play.',
    ach_name_there_is_more: 'There is More',
    ach_desc_there_is_more: 'Select an expansion.',
    ach_name_the_hunter: 'The Hunter',
    ach_desc_the_hunter: 'Defeat three Enemies in a single turn.',
    ach_name_trading_imperialism: 'Trading Imperialism',
    ach_desc_trading_imperialism: 'Obtain Trading Relations.',
    ach_name_peace_was_never_an_option: 'Peace Was Never an Option',
    ach_desc_peace_was_never_an_option: 'Complete the Grand Army.',
    ach_name_richer_than_cresus: 'Richer Than Cresus',
    ach_desc_richer_than_cresus: 'Complete the Extended Treasure.',
    ach_name_adhd: 'ADHD',
    ...
    thirst: 'Thirst',
    historian: 'Historian',
    handy_craftsman: 'Handy Craftsman',
    seasick: 'Seasick',
    ...
    effect_description_forest: "effects/activate Gain resources/wood resources/wood resources/wood , then effects/arrow i18n/felled_forest .",
    ...
    effect_description_explorers: "effects/activate Discover a new territory (71/72/73/74), then effects/arrow i18n/stone_bridge .",
    effect_description_field_worker: "effects/activate Choose a Land in play and gain the resources corresponding to its production.",
    effect_description_servant: "effects/activate Gain resources/coin / resources/wood / resources/stone .",
    effect_description_bandit: "Can be effects/arrow by a Missionary. effects/forced Card Played: Block 1 card with resources/coin production. effects/activate Spend resources/sword to defeat ( effects/destroy ) and gain 2 resources of your choice.",
    effect_description_worker: "effects/activate Choose a Building in play and gain the resources corresponding to its production.",
    ...
    effect_description_army: "effects/time Spend resources/sword to resources/check . At the last card, effects/arrow i18n/grand_army and discover the Vassal State (135).",
    effect_description_grand_army: "effects/time Spend resources/sword to resources/check .",
    effect_description_treasure: "effects/time Spend resources/coin to resources/check , at the last one, effects/arrow i18n/extended_treasure .",
    effect_description_extended_treasure: "effects/time Spend resources/coin to resources/check .",
    effect_description_export: "Spend resources/tradegood to reach tiers: 10: Add resources/coin / resources/wood / resources/stone to a Land, 20: A Person gains \"effects/passive Stays in play.\", 30: Discover Dubbing (86), 40: Add resources/metal / resources/sword / resources/tradegood to 1 Building, 55: Add resources/wood / resources/stone / resources/metal / resources/sword to a card, 75: Add resources/fame x5 to a card, 100: effects/arrow i18n/mass_export . effects/passive Spend resources/tradegood .",
    ...
    effect_description_volcanic_eruption: "effects/forced While in play, destroy the next Land you play; when you do, effects/arrow i18n/ashlands .",
    ...
    effect_description_expanding_borders: "Your kingdom must comprise 75 cards or more (excluding permanents), this card is worth -2 resources/fame for each missing card.",
    effect_description_maximizer: "Worth -1 resources/fame per card worth 0 resources/fame (excluding permanents).",
    effect_description_loyalty: "Worth 25 resources/fame if there are no more enemies in your kingdom.",
    effect_description_trader_obj: "Worth 25 resources/fame if your resources/tradegood production is 10 or more.",
    ...
    effect_description_thunderstorm: "effects/forced Card played: discard the top 3 cards of your deck, then effects/arrow i18n/rain .",
    effect_description_rain: "effects/passive Land product +2 resources/coin . effects/passive You cannot advance. effects/forced End of Turn: effects/arrow i18n/thunderstorm .",
    effect_description_dark_knight: "effects/passive You cannot advance. effects/activate Spend resources/sword resources/sword resources/sword to defeat effects/arrow i18n/impressed_boy .",
    ...
    effect_description_ambassador: "effects/time Spend resources/coin resources/coin resources/coin to discover an ally (121).",
    effect_description_diplomat: "effects/time Spend resources/coin resources/coin resources/coin to discover the Consort (122).",
    ...
    effect_description_witch: "effects/activate Spend resources/sword resources/sword resources/sword to defeat ( effects/destroy ). effects/activate Discard 3 People to effects/arrow i18n/witch_cabin . effects/forced End of turn: Discover the next 2 cards from the box, then effects/arrow i18n/witch_cabin .",
    ...
    effect_description_plague: "effects/passive Stays in play. effects/forced End of Round: Destroy 2 People from your kingdom, then effects/arrow i18n/enemy_soldier .",
    ...
    effect_description_assassin: "effects/forced Destroy the next Person you play, when you do, effects/arrow i18n/enemy_soldier . effects/activate Spend resources/sword resources/sword resources/sword to defeat effects/arrow i18n/enemy_soldier .",
    effect_description_city_fire: "effects/passive Stays in play. effects/forced End of Round: Destroy 1 Building from your kingdom, then effects/arrow i18n/ashlands .",
    effect_description_lost_civilization: "effects/activate Discard 6 friendly cards to discover an Artifact (108).",
    effect_description_skilled_bandit: "Can be effects/arrow by a Missionary. effects/forced Card played: Block 3 cards with production. effects/activate Spend resources/sword resources/sword resources/sword to defeat ( effects/destroy ) and gain 3 resources of your choice.",
    effect_description_dark_prince: "effects/passive You cannot advance. effects/activate Spend resources/sword resources/sword resources/sword resources/sword resources/sword to defeat effects/arrow i18n/impressed_boy .",
    effect_description_innkeeper: "effects/activate Discard another Person to gain 2 resources of your choice.",
    effect_description_tornado: "effects/passive Stays in play. effects/forced End of Round: Destroy 3 friendly (non-permanent) cards from the kingdom, then effects/arrow i18n/flooding .",
    effect_description_flooding: "effects/passive Stays in play. effects/forced Block all Buildings (max 5). effects/forced End of Round: Destroy this card and 1 blocked Building or 2 other friendly (non-permanent) cards.",
    effect_description_young_princess: "effects/forced End of Turn: Discard 2 People or effects/arrow i18n/spoiled_princess .",
    ...
    effect_description_sickness: "effects/forced Card Played: Discard the 2 next cards from your deck.",
    ...
    effect_description_royal_visit: "effects/activate Remove 1 resource in the upgrade cost of a card in play.",
    effect_description_inquisitor: "effects/destroy Destroy a effects/negative card in play.",
    ...
    effect_description_cooperation: "effects/activate Discard 2 People to gain 3 resources of your choice then effects/arrow i18n/favor .",
    effect_description_favor: "effects/passive Stays in play. effects/activate Gain a resource of your choice, then effects/arrow i18n/cooperation .",
    effect_description_aethan_estate_1: "effects/forced When you purge this card, you may cancel the purge of 1 other card.",
    effect_description_aethan_estate_2: "effects/forced When you purge this card, you may cancel the purge of 3 other cards.",
    effect_description_aethan_estate_3: "effects/forced When you purge this card, you may cancel the purge of 2 other cards.",
    ...
    effect_description_dubbing: "effects/passive Stays in play. effects/forced End of Round: Add resources/coin resources/sword and \"Knight\" to 1 Person, then effects/arrow i18n/ renovation.",
    ...
    effect_description_quests: "effects/time Discard People to resources/check .",
    effect_description_a_perfect_tower: "effects/time Spend resources/stone to resources/check .",
    effect_description_town_well: "effects/passive Building production gains +1 resources/coin .",
    effect_description_pit_settlement: "effects/activate Mark 1 effects/check , once complete effects/arrow i18n/prison .",
    ...
    effect_description_jewellery: "effects/time Spend resources/metal to resources/check , then gain 5 resources/tradegood .",
    effect_description_build_an_ark: "effects/time Spend resources/wood to resources/check , once completed, effects/arrow i18n/the_ark ",
    ...
    effect_description_blood_curse: "effects/forced When you Advance, play 2 additional cards.",
    ...
    effect_description_compass: "effects/activate Mark 1 effects/check for each Seafaring card in play, including this one, once complete, effects/arrow i18n/navigation .",
    effect_description_navigation: "effects/activate Mark 1 effects/check for each Seafaring card in play, including this one, once complete, effects/arrow i18n/astrolabe .",
    ...
    effect_description_astrolabe: "effects/activate Mark 1 effects/check for each Seafaring card in play, including this one, once complete, effects/arrow i18n/calendar .",
    effect_description_saw_mill: "effects/activate Discover Build an Ark (91).",
    effect_description_wood_shipment: "effects/passive Combine and exchange your amount of resources/tradegood and resources/wood .",
    effect_description_larger_barns: "effects/optional End of Turn: This card or another of your choice stays in play.",
    effect_description_royal_storehouse: "effects/passive Stays in play. effects/optional End of Turn: 1 card of your choice stays in play.",
    effect_description_fish_quota: "effects/activate Mark 1 effects/check , once completed, effects/arrow i18n/fishing_excellence .",
    ...
    effect_description_missionary: "effects/activate Spend resources/coin resources/coin resources/coin to convert (effects/arrow) a Bandit.",
    ...
    effect_description_groom: "effects/optional Play a horse from the discard. effects/activate Choose a Horse in play with 0 to 3 resources on it, pay resources/coin resources/coin to add any resource to it.",
    ...
    effect_description_small_school: "effects/time Upgrade 1 Person in play for free, then effects/arrow i18n/school .",
    effect_description_school: "effects/time Upgrade 1 Person in play for free, then effects/arrow i18n/prominent_school .",
    effect_description_renowned_school: "effects/time Add 1 resource to a Person in play, then effects/oneTime .",
    effect_description_prominent_school: "effects/time Add 1 resource to a Person in play, then effects/arrow i18n/renowned_school .",
    effect_description_investor_1: "effects/activate Gain 3 resources of your choice, then effects/arrow.",
    effect_description_investor_2: "effects/activate Gain 3 resources of your choice, then effects/arrow.",
    effect_description_investor_3: "effects/activate Gain 1 resource of your choice.",
    effect_description_investor_4: "effects/activate Gain 3 resources of your choice, then effects/arrow. (Will only generate 1 resource)",
    effect_description_queen_jeminah: "effects/activate Discard 1 Person with 5 resources/fame or more to mark 1 effects/check . (Worth 3 resources/fame per effects/check )",
    ...
    effect_description_temple_of_light: "effects/optional End of Turn : Discard so that 5 other cards stay in play. effects/time Spend resources/tradegood resources/tradegood resources/tradegood resources/tradegood to add 1 effects/check . effects/forced Purged: This card is worth +10 resources/fame per effects/check .",
    ...
    effect_description_handsome_rival: "Worth -5 for each unchecked box. effects/passive Cannot be destroyed, unless Lord Nimrod has been destroyed. effects/activate Discard Lord Nimrod and spend the resources of a box to mark effects/check , once completed, effects/arrow i18n/noble_ally .",
    ...
    effect_description_unruly_towns: "Worth the fame of the Vassal States stage. effects/passive Spend resources/sword resources/sword resources/sword resources/sword resources/sword to remove 1 resources/sword from the upgrade cost. effects/forced When you upgrade it, add 20 resources/fame to the final stage (max 9x).",
    ...
    effect_description_bandit_ridding_the_woods: "May be effects/arrow by a Missionary. effects/forced Card Played: Discard every card with a production of resources/wood . effects/time Spend resources/sword resources/sword resources/sword to defeat effects/arrow i18n/prisoner .",
    ...
    effect_description_unsafe_forest: "you must first have the resources before defeating the Enemy to use this effect. effects/optional When you defeat an Enemy, spend resources/coin resources/coin resources/coin resources/coin resources/sword resources/sword to effects/arrow i18n/peaceful_forest .",
    ...
    effect_description_huge_robber: "effects/passive You cannot i18n/advance . effects/activate Discard 4 People to defeat effects/arrow i18n/prisoner .",
    ...
    effect_description_tax_collector: "Worth -1 resources/fame per effects/check . effects/forced Put an effects/check when you produce with this card.",
    effect_description_robber_veteran: "effects/forced Card Played: Discard every card with a production of resources/coin . effects/activate Spend resources/sword resources/sword resources/sword resources/sword resources/sword to defeat effects/arrow i18n/prisoner .",
    ...
    effect_description_rescuer: "effects/forced Card Played: Play 1 Prisoner from the discard. effects/time Spend resources/metal resources/metal resources/metal to defeat effects/arrow i18n/prisoner .",
    ...
    effect_description_ceremony: "effects/activate Discard 5 friendly cards from play to add 5 resources/fame to 1 of them, then effects/arrow i18n/hill_megalith .",
    ...
    effect_description_keeper_of_secrets: "effects/forced Card Played: Discard all cards in play, then effects/arrow i18n/the_chase .",
    effect_description_the_chase: "effects/activate Discard 6 friendly cards to effects/check the next green box. effects/forced End of Turn: effects/check the next red box.",
    ...
    effect_description_treasury: "effects/time Spend resources/coin to effects/check , after the last one effects/arrow i18n/famed_treasury .",
    effect_description_famed_treasury: "effects/time Spend resources/coin to effects/check .",
    ...
    effect_description_stop_distant_lands_4: 'effects/destroy Your deck will now only contain all your Seafaring cards and 6 People, then effects/arrow all Cargos (this will invert the effects/check on each card) and finally discover 7 cards (235-241).',
    effect_description_fleet_maneuvers: 'effects/time Discard the number of Seafarings to effects/check .',
    effect_description_planning: 'effects/time  Discard 1 Person to effects/check .',
    effect_description_well_prepared: 'effects/passive One per turn, effects/check to not end the turn when upgrading a card.',
    effect_description_hardships: 'effects/passive Discard 2 Persons to effects/check .',
    effect_description_friendship: 'effects/passive Discard 2 Persons to gain any 1 resource.',
    effect_description_sun_stroke: 'effects/forced Discard the first Person played each turn without resolving its effect. effects/forced End of Round : effects/arrow .',
    effect_description_thirst: 'effects/forced The first resource you gain each turn is lost. effects/time Spend resources/coin resources/coin resources/coin resources/coin to effects/destroy .',
    effect_description_historian: 'Worth 2 resources/fame per effects/check . effects/time effects/check .',
    ...
    eor_export_40: " (seuil 40): Add resources/metal / resources/sword / resources/tradegood to 1 Building",
    eor_export_55: " (seuil 55): Add resources/wood / resources/stone / resources/metal / resources/sword to 1 card",
    eor_export_75: " (seuil 75): Add resources/fame x5 to 1 card",
    eor_export_100: " (seuil 100): Flip this card",
    eor_mass_export_25: " (seuil 25): Add 1 resources/fame to 2 Lands",
    eor_mass_export_50: " (seuil 50): Add 5 resources/fame to 1 Person",
    eor_mass_export_75: " (seuil 75): Discover Royal Visit (107)",
    eor_mass_export_100: " (seuil 100): Add 5 resources/fame to 1 Building",
