...
Ceci est un projet de fan non officiel et n'est pas affilié, approuvé ou sponsorisé par FryxGames, Intrafin ou Jonathan Fryxelius. Tous les droits sur le jeu original, les règles et les illustrations restent la propriété de leurs détenteurs respectifs.`,
  ...
  guideContent: `<ul class="list-disc pl-5">
    ...
    effect_description_rain: "effects/passive La production des Terrains est doublée. effects/passive Vous ne pouvez jouer aucune carte. effects/forced Fin du Tour: → i18n/thunderstorm .",
    effect_description_dark_knight: "effects/passive Vous ne pouvez ni jouer, ni améliorer de cartes, ni même utiliser les effets effects/time . effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre → i18n/impressed_boy .",
    ...
    effect_description_dark_prince: "effects/passive Vous ne pouvez ni jouer, ni améliorer de cartes, ni utiliser effects/time . effects/activate Dépensez resources/sword resources/sword resources/sword resources/sword resources/sword pour vaincre → i18n/impressed_boy .",
    effect_description_innkeeper: "effects/activate Défaussez une autre Personne pour gagner 2 ressources de votre choix.",
    effect_description_tornado: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 3 cartez alliées du royaume, puis → i18n/flooding .",
    ...
    effect_description_sickness: "effects/forced Carte Jouée: Défaussez la prochaine carte de votre deck.",
...
This is an unofficial fan project and is not affiliated with, endorsed by, or sponsored by FryxGames, Intrafin, or Jonathan Fryxelius. All rights to the original game, rules, and artwork remain with their respective copyright holders.`,
  ...
  guideContent: `<ul class="list-disc pl-5">
    ...
    effect_description_rain: "effects/passive Land production is doubled. effects/passive You cannot play any card. effects/forced End of Turn: → i18n/thunderstorm .",
    effect_description_dark_knight: "effects/passive You cannot play, upgrade cards, or use effects/time effects. effects/activate Spend resources/sword resources/sword resources/sword to defeat → i18n/impressed_boy .",
    ...
    effect_description_dark_prince: "effects/passive You cannot play, upgrade cards, or use effects/time . effects/activate Spend resources/sword resources/sword resources/sword resources/sword resources/sword to defeat → i18n/impressed_boy .",
    effect_description_innkeeper: "effects/activate Discard another Person to gain 2 resources of your choice.",
    effect_description_tornado: "effects/passive Stays in play. effects/forced End of Round: Destroy 3 friendly cards from the kingdom, then → i18n/flooding .",
