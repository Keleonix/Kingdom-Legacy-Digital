...
const translations: Record<Language, Record<TranslationKeys, string>> = {
  fr: {
    ...
    effect_description_prosperity_expansion: "Jouez 1 manche durant laquelle la production de toutes les cartes alliées ont +1 resources/coin , puis ->.",
    effect_description_hoarding: "Jouez 1 manche durant laquelle une carte de votre choix reste en jeu à chaque tour, puis ->.",
    effect_description_royal_decree: "Jouez 1 manche, puis, pour chaque effects/check sur Soulèvement, vous devez barrer 1 production sur 1 carte. Après quoi, détruisez cette extension.",
    effect_description_uprising: "Jouez 1 manche durant laquelle vous devez inscrire 1 effects/check à chaque fois qu'une Personne est jouée alors qu'une autre Personne est déjà en jeu, puis ->.",
  ...
  en: {
    ...
    effect_description_prosperity_expansion: "Play 1 round during which all friendly card production has +1 resources/coin , then ->.",
    effect_description_hoarding: "Play 1 round during which a card of your choice stays in play each turn, then ->.",
    effect_description_royal_decree: "Play 1 round, then, for each effects/check on Uprising, you must cross out 1 production on 1 card. After which, destroy this extension.",
    effect_description_uprising: "Play 1 round during which you must mark 1 effects/check each time a Person is played while another Person is already in play, then ->.",
