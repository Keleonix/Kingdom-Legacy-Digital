...
const translations: Record<Language, Record<TranslationKeys, string>> = {
  fr: {
    ...
    effect_description_forest: "effects/activate Gagnez resources/wood resources/wood resources/wood , puis Front Down.",
    ...
    effect_description_army: "effects/time Dépensez les resources/sword (1 à 10, incrément de 1) pour cocher la case de gauche à droite, à la dernière carte, Back Up et découvrez l'Etat Vassal (135).",
    ...
    effect_description_thunderstorm: "effects/forced Carte jouée: défaussez les 3 premières cartes de votre pioche, puis -> (Back Up).",
    ...
    effect_description_dark_knight: "effects/passive Vous ne pouvez ni jouer, ni améliorer de cartes, ni même utiliser les effets effects/time . effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre (-> Back Up).",
    ...
    effect_description_witch: "effects/activate Dépensez resources/sword resources/sword resources/sword pour vaincre ( effects/destroy ). effects/activate Défaussez 3 Personnes pour -> (Back Up). effects/forced Fin du tour: Découvrez les 2 prochaines cartes de la boîte, puis -> (Back Up).",
    ...
    effect_description_plague: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 2 Personnes de votre royaume, puis -> (Back Front).",
    ...
    effect_description_city_fire: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 1 Bâtiment de votre royaume, puis -> (Back Up).",
    ...
    effect_description_tornado: "effects/passive Reste en jeu. effects/forced Fin de Manche: Détruisez 3 cartez alliées du royaume, puis -> (Back Up).",
    ...
    effect_description_young_princess: "effects/forced Fin du Tour: Défaussez 2 Personnes ou Front Down.",
    ...
    effect_description_investor_1: "effects/activate Gagnez 3 ressources au choix, puis Front Down.",
    effect_description_investor_2: "effects/activate Gagnez 3 ressources au choix, puis Back Down.",
    effect_description_investor_3: "effects/activate Gagnez 1 ressource au choix.",
    effect_description_investor_4: "effects/activate Gagnez 3 ressources au choix, puis Back Up.",
    ...
    effect_description_prosperity_expansion: "effects/passive Toutes les cartes alliées ont +1 resources/coin . effects/passive Change pour Engranger des réserves à la fin de la manche.",
    effect_description_hoarding: "effects/passive Une carte de votre choix reste en jeux chaque tour. effects/passive Change pour Soulèvement à la fin de la manche.",
    effect_description_royal_decree: "effects/passive À la fin de cette manche, pour chaque effects/check sur Soulèvement, retirez 1 production sur 1 carte. effects/passive À la fin du tour, effects/destroy cette carte.",
    effect_description_uprising: "effects/passive Mettez 1 effects/check sur cette carteà chaque fois qu'une Personne est jouée alors qu'une autre est déjà en jeu. effects/passive Change pour Décret Royal à la fin de la manche.",
    effect_description_the_water_mill_expansion: "Jouez 1 manche durant laquelle vous pouvez gagner resources/coin resources/coin resources/coin une fois par tour, puis ->.",
    effect_description_efficient_farming: "Jouez 1 manche. effects/time Défaussez 2 Bâtiments pour ajouter une resources/coin à un Terrain en jeu, puis ->.",
    effect_description_obsolete_farms: "Jouez 1 manche, puis, détruisez cette extension avec 1 carte avec une production d' resources/coin .",
    effect_description_surplus: "Jouez 1 manche durant laquelle les Terrains produisent de l' resources/coin peuvent produire des resources/tradegood à la place, puis ->.",
  ...
  en: {
    ...
    effect_description_prosperity_expansion: "effects/passive All friendly card production has +1 resources/coin . effects/passive Go to Hoarding at the end of round.",
    effect_description_hoarding: "effects/passive A card of your choice stays in play each turn. effects/passive Go to Uprising at the end of turn.",
    effect_description_royal_decree: "effects/passive At the end of this round, for each effects/check on Uprising, remove 1 production on 1 card. effects/passive At the end of this round, effects/destroy this card.",
    effect_description_uprising: "effects/passive Put 1 effects/check on this, each time a Person is played while another Person is already in play. effects/passive Go to Royal Decree at the end of turn.",
    effect_description_the_water_mill_expansion: "Play 1 round during which you can gain resources/coin resources/coin resources/coin once per turn, then ->.",
    effect_description_efficient_farming: "Play 1 round. effects/time Discard 2 Buildings to add a resources/coin to a Land in play, then ->.",
    effect_description_obsolete_farms: "Play 1 round, then, destroy this extension with 1 card with a resources/coin production.",
    effect_description_surplus: "Play 1 round during which Lands producing resources/coin can produce resources/tradegood instead, then ->.",
