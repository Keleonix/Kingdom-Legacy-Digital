...
export const allCards: GameCard[] = [
  ...
  { id: 25,
    ...
    choice: false,
    checkboxes: [
      [ {content: "fame x1", checked: false, count: 1},
        {content: "fame x4", checked: false, count: 2},
        {content: "fame x7", checked: false, count: 3},
        {content: "fame x10", checked: false, count: 4},
        {content: "fame x14", checked: false, count: 5},
        {content: "fame x19", checked: false, count: 6},
      ...
      [],
      [
        {content: "fame x10", checked: false, count: 10},
        {content: "fame x20", checked: false, count: 10},
        {content: "fame x30", checked: false, count: 12},
        {content: "fame x40", checked: false, count: 12},
        {content: "fame x50", checked: false, count: 15}
      ],
      []
    ],
    negative: [false, false, false, false],
  ...
  { id: 26,
    ...
    checkboxes: [
      [ {content: "fame x1", checked: false, count: 1},
        ...
        {content: "fame x3", checked: false, count: 3},
        {content: "fame x5", checked: false, count: 4},
        {content: "fame x7", checked: false, count: 5},
        {content: "fame x10", checked: false, count: 6},
        {content: "fame x14", checked: false, count: 7},
        {content: "fame x19", checked: false, count: 8},
      ...
      [],
      [
        {content: "fame x10", checked: false, count: 13},
        {content: "fame x20", checked: false, count: 14},
        {content: "fame x30", checked: false, count: 15},
        {content: "fame x40", checked: false, count: 16},
        {content: "fame x50", checked: false, count: 17}
      ],
      []
    ],
    negative: [false, false, false, false],
  ...
  { id: 27,
    ...
    choice: false,
    checkboxes: [
      [ {content: "", checked: false, count: 10},
        {content: "", checked: false, count: 20},
        {content: "", checked: false, count: 30},
      ...
      [],
      [
        {content: "", checked: false, count: 25},
        {content: "", checked: false, count: 50},
        {content: "", checked: false, count: 75},
        {content: "", checked: false, count: 100},
        {content: "", checked: false, count: 150},
        {content: "", checked: false, count: 200},
        {content: "", checked: false, count: 250}
      ],
      []
    ],
    negative: [false, false, false, false],
  ...
  { id: 87,
    ...
    checkboxes: [
      [ {content: "fame x1", checked: false, count: 1},
        {content: "fame x3", checked: false, count: 2},
        {content: "fame x6", checked: false, count: 2},
        {content: "fame x10", checked: false, count: 3},
        {content: "fame x14", checked: false, count: 3},
        {content: "fame x20", checked: false, count: 4},
        {content: "fame x27", checked: false, count: 5},
        {content: "fame x35", checked: false, count: 6},
        {content: "fame x45", checked: false, count: 7}
      ],
      [],
      [],
      []
  ...
  { id: 88,
    ...
    choice: false,
    checkboxes: [
      [ {content: "fame x3", checked: false, count: 1},
        {content: "fame x6", checked: false, count: 2},
        {content: "fame x10", checked: false, count: 3},
        {content: "fame x15", checked: false, count: 4},
        {content: "fame x22", checked: false, count: 5},
        {content: "fame x30", checked: false, count: 6},
        {content: "fame x38", checked: false, count: 7},
        {content: "fame x48", checked: false, count: 8},
        {content: "fame x60", checked: false, count: 9},
        {content: "fame x75", checked: false, count: 10}
      ],
      [],
      [],
      []
  ...
  { id: 90,
    ...
    checkboxes: [
      [ {content: "fame x1", checked: false, count: 1},
        ...
        {content: "fame x10", checked: false, count: 6},
        {content: "fame x14", checked: false, count: 7},
        {content: "fame x20", checked: false, count: 8},
        {content: "fame x28", checked: false, count: 9},
        {content: "fame x40", checked: false, count: 10}
      ],
      [],
      [],
      []
  ...
  { id: 91,
    ...
    checkboxes: [
      [
        {content: '', checked: false, count: 2},
        {content: '', checked: false, count: 4},
        {content: '', checked: false, count: 6},
        {content: '', checked: false, count: 8},
        {content: '', checked: false, count: 10}
      ],
      [],
      [ {content: '', checked: false},
  ...
  { id: 167,
    ...
    checkboxes: [
      [
        {content: "fame", checked: false, count: 1},
        {content: "fame x2", checked: false, count: 2},
        {content: "fame x3", checked: false, count: 3},
        {content: "fame x5", checked: false, count: 4},
        {content: "fame x7", checked: false, count: 5},
      ...
      [
        ...
        {content: "fame x40", checked: false, count: 16},
        {content: "fame x50", checked: false, count: 17},
        {content: "fame x60", checked: false, count: 18},
        {content: "fame x70", checked: false, count: 19},
        {content: "fame x80", checked: false, count: 20},
        {content: "fame x100", checked: false, count: 25},
        {content: "fame x125", checked: false, count: 30}
      ],
      []
    ],
    negative: [false, false, false, false],
  ...
  { id: 216,
    name: ['beach', 'shipyard', 'harbour', 'loading_dock'],
    resources: [
      [ { coin: 1 } ],
      [ emptyResource ],
      [ { tradegood: 1, fame: 2 } ],
    ...
    upgrades: [
      [
        {cost: { wood: 3 }, nextSide: 2},
        {cost: { wood: 2, stone: 2 }, nextSide: 3}
      ],
      [],
      [
        {cost: { wood: 2 }, nextSide: 4}
      ],
      [],
    ],
    currentSide: 1,
  ...
  { id: 219,
    name: ['construction_site', 'ship_hull', 'reinforced_ship', 'ship'],
    resources: [
      [ emptyResource ],
      [ emptyResource ],
      [ { sword: 1, fame: 5 } ],
    ...
    upgrades: [
      ...
      [{ cost: { coin: 3, wood: 1 }, nextSide: 4 }],
      [],
      [{ cost: { coin: 2, wood: 1, metal: 2 }, nextSide: 3 }],
    ],
    currentSide: 1,
    type: ['land', 'building', 'seafaring - ship', 'seafaring - ship'],
    choice: false,
  ...
  { id: 222,
    ...
    checkboxes: [
      ...
      [],
      [
        {content: "stone", checked: false}, {content: "stone", checked: false},
        {content: "stone", checked: false}, {content: "stone", checked: false},
        {content: "stone", checked: false}, {content: "stone", checked: false},
        {content: "stone", checked: false}, {content: "stone", checked: false},
        {content: "stone", checked: false}, {content: "stone", checked: false},
  ...
  { id: 224,
    name: ['supply_barrel', '', 'supply_barrel', ''],
    resources: [
      [],
      [],
      [],
  ...
  { id: 226,
    name: ['metal_supply', '', 'metal_supply', ''],
    resources: [
      [],
      [],
      [],
    ...
    checkboxes: [
      ...
      [],
      [
        {content: "metal", checked: false}, {content: "metal", checked: false},
        {content: "metal", checked: false}, {content: "metal", checked: false},
        {content: "metal", checked: false}, {content: "metal", checked: false},
        {content: "metal", checked: false}, {content: "metal", checked: false},
        {content: "metal", checked: false}, {content: "metal", checked: false},
  ...
  { id: 227,
    name: ['weapon_supply', '', 'weapon_supply', ''],
    resources: [
      [],
      [],
      [],
    ...
    checkboxes: [
      ...
      [],
      [
        {content: "sword", checked: false}, {content: "sword", checked: false},
        {content: "sword", checked: false}, {content: "sword", checked: false},
        {content: "sword", checked: false}, {content: "sword", checked: false},
        {content: "sword", checked: false}, {content: "sword", checked: false},
        {content: "sword", checked: false}, {content: "sword", checked: false},
  ...
  { id: 242,
    name: ['repairs_needed', '', 'beyond_repair', ''],
    resources: [
      [],
      [],
      [],
    ...
    checkboxes: [
      [
        {content: "green", checked: false}, {content: "green", checked: false}, {content: "green effects/destroy", checked: false},
        {content: "red", checked: false}, {content: "red", checked: false}, {content: "red effects/arrow", checked: false},
      ],
      [],
      [],
      [],
  ...
  { id: 243,
    name: ['freeloader', 'apprentice', 'errand_boy', 'scribe'],
    resources: [
      [],
      [ { coin: 1 } ],
      [],
  ...
  { id: 249,
    name: ['merchant_ship', '', 'skilled_trader', ''],
    resources: [
      [],
      [],
      [],
    ...
    currentSide: 1,
    type: ['event - permanent', '', 'person - seafaring', ''],
    choice: false,
    checkboxes: [],
    negative: [false, false, false, false],
    discoverable: true,
  ...
  { id: 259,
    name: ['cursed_dubloon', '', 'blood_curse', ''],
    resources: [
      [],
      [],
      [],
  ...
  { id: 260,
    ...
    currentSide: 1,
    type: ['enemy - permanent', '', 'event - permanent', ''],
    choice: false,
    checkboxes: [
      [
        {content: "", checked: false},
  ...
  { id: 264,
    ...
    checkboxes: [
      ...
      [
        {content: '', checked: false}, {content: '', checked: false},
        {content: '', checked: false}, {content: '', checked: false},
        {content: '', checked: false}, {content: 'effects/oneTime', checked: false},
      ],
      [],
    ],
    negative: [false, false, false, false],
  ...
  { id: 268,
    name: ['reef_of_despair', '', 'shipwreck', ''],
    resources: [
      [
        emptyResource
      ],
