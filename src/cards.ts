...
export const allCards: GameCard[] = [
  ...
  },
  {
    ...
    effects: [
      "effects/forced Fin du tour: Défaussez pour que 1 ou 2 autres cartes restent en jeu.",
      "",
  ...
  },
  {
    ...
    effects: [
      "(Choisissez le côté) effects/forced Carte Jouée: Défaussez 2 Personnes. effects/activate Dépensez resources/miltary resources/miltary resources/miltary resources/miltary pour vaincre ( effects/).",
      "",
  ...
  },
  {
    ...
    effects: [
      ...
      "effects/time Gagnez 3 ressources au choix, puis Back Down.",
      "effects/time Gagnez 1 ressource au choix.",
      "effects/time Gagnez 3 ressources au choix, puis Back Up.",
    ],
    upgrades: [
      [],
      [],
  ...
  },
  {
    ...
    effects: [
      ...
      "",
      "effects/optional Lorsque vous l'améliorez ajoutez 1 Terrain gagne \" effects/passive Reste en jeu. \".",
    ],
    upgrades: [
  ...
  },
  {
    ...
    effects: [
      ...
      "Jouez 1 manche. effects/time Défaussez 2 Bâtiments pour ajouter une resources/gold à un Terrain en jeu. Puis -> (Back Down).",
  ...
  },
  {
    ...
    effects: [
      ...
      "Jouez 1 manche. Puis -> (Back Down). effects/forced Lorsqu'une Personne est jouée, inscrivez 1 effects/check ou défaussez 2 cartes alliées. Une fois complétée, défaussez toute votre pioche.",
      ...
      "Jouez 1 manche. effects/forced Fin du Tour: Si vous n'avez aucune resources/military , enlevez 1 production d'1 carte en jeu. effects/mandator Fin de Manche: Ajoutez une ressource (non- resources/fame ) au choix à une carte alliée, puis -> (Back Up).",
    ],
    upgrades: [
      [],
      [],
